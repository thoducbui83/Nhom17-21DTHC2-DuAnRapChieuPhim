...
namespace DuAnRapChieuPhim.Controllers
{
    ...
    .ToList();
        ...
        private void SendNewPasswordByEmail(string userEmail, string newPassword)
        {
            ...
            string smtpUsername = "nguyenkhanhhuynh1602@gmail.com";
            string smtpPassword = "rydvhfohcqpytvic";

            // Địa chỉ email người gửi
            string fromEmail = "nguyenkhanhhuynh1602@gmail.com";
        ...
        private void SendEmail(long id)
        {
            ...
            string senderEmail = "nguyenkhanhhuynh1602@gmail.com";
            string senderPassword = "rydvhfohcqpytvic";
            string smtpServer = "smtp.gmail.com";
